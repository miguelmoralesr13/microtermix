...
import { SemgrepSidebarList } from './components/SemgrepSidebarList';
...
import { countBySeverity } from '../domain';
...
export const SemgrepPanel: React.FC = () => {
    ...
    const severityCounts = useMemo(() => countBySeverity(currentFindings), [currentFindings]);
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    <div className="bg-slate-950/50 border border-slate-800 rounded-2xl p-4 flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-3xl font-black text-red-400">{severityCounts.ERROR}</p>
                                        </div>
