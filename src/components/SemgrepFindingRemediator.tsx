...
import { SemgrepFinding } from '../stores/semgrepStore';
...
export const SemgrepFindingRemediator: React.FC<SemgrepRemediatorProps> = ({ 
    ...
    const getLanguage = () => {
        const ext = finding.path.split('.').pop()?.toLowerCase();
                        ...
                        <div className="flex-1">
                            <Editor
                                ...
                                onMount={(editor) => {
                                    ...
                                    // Desactivar específicamente los marcadores de diagnóstico (rojos/amarillos)
