      ...
      <div className="px-4 py-3 border-b border-slate-800 bg-slate-900/40 flex items-center justify-between shrink-0">
        <div className="flex flex-col gap-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <Badge 
              variant="outline" 
              className={`text-[9px] h-4.5 px-1.5 tabular-nums border-slate-800 ${
                isExpress ? 'text-blue-400 border-blue-900/50 bg-blue-500/5' : 'text-emerald-400 border-emerald-900/50 bg-emerald-500/5'
              }`}
            >
                    ...
                    <div className="flex-1 py-1">
                      {stateNames.map(name => (
                        <button
                          ...
                          className={`w-full text-left px-3 py-1.5 text-[11px] truncate transition-all border-l-2 ${
                            selectedStateName === name 
                              ? 'bg-microtermix-neon/10 text-microtermix-neon border-microtermix-neon font-medium' 
