...
export const SemgrepSidebarList: React.FC<SemgrepSidebarListProps> = ({
    ...
    const config = useMemo<SidebarListConfig<Project>>(() => ({
        getKey:  p => p.path as string,
        getText: p => <SemgrepProjectContent path={p.path as string} name={p.name as string} />,
        getPost: p => <SemgrepFindingsDot path={p.path as string} />,
