                    ...
                    return (
                        <ContextMenu key={serviceId}>
                            <ContextMenuTrigger>
                                <TooltipProvider delay={400}>
                                    ...
                                    >
                                        ...
                                        <button
                                            onClick={(e) => { e.stopPropagation(); onTabClose(serviceId); }}
                            ...
                            <ContextMenuContent className="w-52 bg-[#0a0c10] border-slate-800 shadow-2xl">
                                ...
                                <ContextMenuItem 
                                    onClick={() => onTabRestart(serviceId)}
