...
import { parseProperties, stringifyProperties, type SonarProperties } from '@/utils/propertiesUtils';
import { cn } from '@/lib/utils';
import type { SonarProjectLink } from '../../domain';

interface SonarSettingsDialogProps {
    isOpen: boolean;
    onOpenChange: (open: boolean) => void;
    link: Partial<SonarProjectLink>;
    onLinkChange: (patch: Partial<SonarProjectLink>) => void;
    projectPath: string;
    projectName: string;
}
...
export const SonarSettingsDialog: React.FC<SonarSettingsDialogProps> = ({
    ...
    const loadProperties = useCallback(async (forcedName?: string) => {
        ...
        try {
            ...
            const patch: Partial<SonarProjectLink> = { propertiesFileName: targetFile };
    ...
    }, [isOpen, projectPath, link.propertiesFileName]);
